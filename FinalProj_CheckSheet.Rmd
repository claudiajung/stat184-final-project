...
(B) .Rmd Line number(s) for a join operation: 119, 146
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 153-157
...
(E) .Rmd Line number(s) for use of decision tree or dendogram results:   153-157 
