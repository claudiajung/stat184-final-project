...
summary(lmStarbucks)
```
### Machine Learning - Predicting number of Starbucks/probability of opening a new Starbucks in a particular city

```{r}
#Predicting probability of a starbucks 
data("NCHS")
...
mod1 <- party::ctree(
  Number.of.Starbucks ~ totalPopulation,
  data=JointTable)
